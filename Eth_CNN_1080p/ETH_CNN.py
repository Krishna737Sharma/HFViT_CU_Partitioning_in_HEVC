...
# File paths
train_file_path = "/raid/somdyutiai/Krishna_24AI60R38/PycharmProjects/HEVC_Intra_Models-ETH-CNN_Pt/Data/1080p_dataset/AI_Train_163200.dat_shuffled"
validation_file_path = "/raid/somdyutiai/Krishna_24AI60R38/PycharmProjects/HEVC_Intra_Models-ETH-CNN_Pt/Data/1080p_dataset/AI_Valid_9600.dat_shuffled"
test_file_path = "/raid/somdyutiai/Krishna_24AI60R38/PycharmProjects/HEVC_Intra_Models-ETH-CNN_Pt/Data/1080p_dataset/AI_Test_19200.dat_shuffled"
...
def save_plots(epoch, history):
    """Save training plots from history dictionary"""
...
# Optimizer and scheduler - FIXED: Use uppercase CONFIG variable
optimizer = optim.SGD(model.parameters(), lr=CONFIG_LEARNING_RATE, momentum=CONFIG_MOMENTUM)
...
for epoch in range(start_epoch, CONFIG_EPOCHS + 1):
    ...
    # Patience check -> Reload best model + Shuffle training
    ...
    # After 3 training shuffles -> Shuffle validation
    ...
    # Validation Phase (Every 1 epochs)
    if epoch % 1 == 0:
        model.eval()
        v_loss = 0.0
        v_acc = 0.0
        ...
        # Always save regular checkpoint after validation
        torch.save({
            'epoch': epoch,
            'model_state_dict': model.state_dict(),
            'optimizer_state_dict': optimizer.state_dict(),
